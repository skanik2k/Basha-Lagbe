<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
            ...
            <div class="main-nav secondary-nav hover-success-nav py-2">
                <div class="container">
                    <div class="row">
						<div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img style="height: 50px; width: 65px" class="nav-logo" src="images/logo/restatelg.png" alt=""></a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
									...
									<a class="btn btn-success d-none d-xl-block" style="border-radius:30px;" href="submitproperty.php">Submit </a> 
                                </div>
                            </nav>
                        </div>
                    </div>
